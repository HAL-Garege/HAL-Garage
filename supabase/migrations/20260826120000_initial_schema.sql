...
create index if not exists idx_cash_movements_date on cash_movements(created_at desc);
...
('Lavado exterior'),('Lavado completo'),('Aspirado'),('Encerado'),
('Lavado de motor'),('Pulido'),('Detailing'),('Ceramicado'),('Otro servicio')
on conflict (name) do nothing;

insert into product_categories(name) values
('Limpieza Exterior'),('Limpieza Interior'),('Acabado'),('Limpieza Motor'),('Accesorios'),('Otros')
on conflict (name) do nothing;

-- IMPORTANTE:
-- Las políticas RLS y la creación de perfiles de Auth se añadirán
-- después de crear el proyecto Supabase y definir los IDs reales.
